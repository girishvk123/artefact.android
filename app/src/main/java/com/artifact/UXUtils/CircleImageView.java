...
public class CircleImageView extends ImageView {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float rWidth = 96;
        width = ImageUtils.convertDpToPixel(rWidth,this.getContext());
        height = ImageUtils.convertDpToPixel(rWidth,this.getContext());
        ...
        //canvas.drawCircle(800 / 2.0f, 800 / 2.0f, mDrawableRadius, mBitmapPaint);
        if (mBorderWidth != 0) {
